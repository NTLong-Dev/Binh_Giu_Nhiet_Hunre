...
function capNhat_ThongTin_CurrentUser() {
    ...
    if (u) {
        ...
        document.getElementsByClassName('member')[0]
            ...
            document.querySelector('.top-nav-quicklink li:last-child').style.display = 'none';
	...
	<div class="top-nav group">
        <section>
            ...
            <ul class="top-nav-quicklink flexContain">
                ...
                <li><a href="tuyendung.html"><i class="fa fa-handshake-o"></i> Góp ý & phản hồi </a></li>
                <li><a href="lienhe.html"><i class="fa fa-phone"></i> Liên hệ</a></li>
                <li><a href="trungtambaohanh.html"><i class="fa fa-sign-in" aria-hidden="true"></i> Đăng nhập</a></li>
            </ul> <!-- End Quick link -->
        </section><!-- End Section -->
    </div><!-- End Top Nav  -->`);
}
...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/Bình Nước.png" alt="Trang chủ" title="Trang chủ">
            </a>
        </div> <!-- End Logo -->

        <div class="content">
            <div class="search-header" style="position: relative; left: 10px; top: 1px;">
